/**
 * This file1 contains the configuration used for customising the website, such as the folder to share,
...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'admin@himei.onmicrosoft.com',
